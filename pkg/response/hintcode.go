...
const (
	...
	// HintCodeUserCallConfirm is the hint for when the order is waiting for the user to confirm that they have
	// received this order while in a call with your organization.
